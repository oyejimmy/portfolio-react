    ...
    <section id="education" className="py-20 bg-white" data-testid="education-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div className="text-center mb-16" {...fadeInUp}>
          <h2 className="text-4xl lg:text-5xl font-bold text-slate-800 mb-4" data-testid="education-title">
            Education
          </h2>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="flex-1">
                  <div className="flex items-center mb-4">
                    <GraduationCap className="text-2xl text-indigo-600 mr-3" />
                  ...
                  {(edu.thesis || edu.achievement) && (
                    <div className="mb-4">
                      <Badge variant="outline" className="bg-indigo-50 text-indigo-700 border-indigo-200">
                        ...
                        {edu.thesis ? `Thesis: ${edu.thesis}` : edu.achievement}
                      </Badge>
                    </div>
                  )}
                </div>
                <div className="mt-4 md:mt-0 md:ml-8 text-center">
                  <div className="bg-gradient-to-br from-indigo-600 to-purple-600 text-white rounded-2xl p-4">
                    <div className="text-sm font-medium opacity-90 mb-1">Period</div>
        ...
        >
          <div className="flex items-center justify-center mb-6">
            ...
            <h3 className="text-2xl font-semibold text-slate-800">Continuous Learning</h3>
          </div>
